...
namespace XenkoToolkit.Mathematics
{
    ...
    public static partial class Easing
    {
        ...
        {
            return (float)Math.Sin((p - 1) * MathUtil.PiOverTwo) + 1;
        }
        ...
        {
            return (float)Math.Sin(p * MathUtil.PiOverTwo);
        }
        ...
        {
            return 0.5f * (1 - (float)Math.Cos(p * MathUtil.Pi));
        }
        ...
        {
            return (float)Math.Sin(13 * MathUtil.PiOverTwo * p) * (float)Math.Pow(2, 10 * (p - 1));
        }
        ...
        {
            return (float)Math.Sin(-13 * MathUtil.PiOverTwo * (p + 1)) * (float)Math.Pow(2, -10 * p) + 1;
        }
        ...
        public static float ElasticEaseInOut(float p)
        {
            if (p < 0.5f)
            {
                return 0.5f * (float)Math.Sin(13 * MathUtil.PiOverTwo * (2 * p)) * (float)Math.Pow(2, 10 * ((2 * p) - 1));
            }
            else
            {
                return 0.5f * ((float)Math.Sin(-13 * MathUtil.PiOverTwo * ((2 * p - 1) + 1)) * (float)Math.Pow(2, -10 * (2 * p - 1)) + 2);
            }
        }
        ...
        {
            return p * p * p - p * (float)Math.Sin(p * MathUtil.Pi);
        }
